...
public:
  ...
  SetBaseVelocityActionHandler(P2PPacketStreamArduino *p2p_stream, WheelSpeedController *wheel_speed_controller)
    : P2PActionHandler<P2PSetBaseVelocityRequest>(P2PAction::kSetBaseVelocity, p2p_stream), 
      wheel_speed_controller_(*ASSERT_NOT_NULL(wheel_speed_controller)) {}

  bool Run() override;

private:
  WheelSpeedController &wheel_speed_controller_;
};
