...
constexpr float kRedHue = 0.0f;
constexpr float kYellowHue = 1 / 6.0f;
constexpr float kGreenHue = 2 / 6.0f;
constexpr float kCyanHue = 3 / 6.0f;
constexpr float kBlueHue = 4 / 6.0f;
