...
template<int MaxNumTrajectoriesPerType, int MaxNumWaypointsPerBaseTrajectory, int MaxNumWaypointsPerHeadTrajectory, int MaxNumWaypointsPerEnvelopeTrajectory, int MaxNumLedTrajectories, int MaxNumWaypointsPerLedHSVTrajectory> 
...
public:
  ...
  Store<Trajectory<ColorHSVTargetState, MaxNumWaypointsPerLedHSVTrajectory>, MaxNumLedTrajectories> &led_hsv_trajectories() { return led_hsv_trajectories_; }
  ...
  Store<TrajectoryView<ColorHSVTargetState>, MaxNumLedTrajectories> &led_hsv_trajectory_views() { return led_hsv_trajectory_views_; }
  ...
  Store<LedHSVModulatedTrajectoryView, MaxNumLedTrajectories> &led_hsv_modulated_trajectory_views() { return led_hsv_modulated_trajectory_views_; }
  ...
  Store<MixedTrajectoryView<ColorHSVTargetState>, MaxNumLedTrajectories> &led_hsv_mixed_trajectory_views() { return led_hsv_mixed_trajectory_views_; }
...
private:
  ...
  Store<Trajectory<ColorHSVTargetState, MaxNumWaypointsPerLedHSVTrajectory>, MaxNumLedTrajectories> led_hsv_trajectories_;
  ...
  Store<TrajectoryView<ColorHSVTargetState>, MaxNumLedTrajectories> led_hsv_trajectory_views_;
  ...
  Store<LedHSVModulatedTrajectoryView, MaxNumLedTrajectories> led_hsv_modulated_trajectory_views_;
  ...
  Store<MixedTrajectoryView<ColorHSVTargetState>, MaxNumLedTrajectories> led_hsv_mixed_trajectory_views_;
};

using TrajectoryStore = TrajectoryStore_</*MaxNumTrajectoriesPerType=*/32, kP2PMaxNumWaypointsPerBaseTrajectory, kP2PMaxNumWaypointsPerHeadTrajectory, kP2PMaxNumWaypointsPerEnvelopeTrajectory, /*MaxNumLedTrajectories=*/4, kP2PMaxNumWaypointsPerLedHSVTrajectory>;
